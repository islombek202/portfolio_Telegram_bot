...
2. SHOP.uz-portfolio_web-site🛒  
   [Website](https://shop-uz-portfolio-web-site.vercel.app)

3. Counter-hisoblagich🧮  
   [Website](https://counter-hisoblagich.vercel.app)

4. Tic-Tac-Toe❌⭕  
   [Website](https://tic-tac-toe-kappa-two-24.vercel.app)

5. iOS Calculator📱  
   [Website](https://ios-calculator-example.vercel.app)"""
